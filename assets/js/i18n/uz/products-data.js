...
var FFSG_PRODUCTS = {
  brooksAdrenaline: {
    ...
    brand: "Brooks",
    category: "running",
    categoryLabel: "Yugurish",
    img: "/assets/images/products/brooks-adrenaline-gts.webp",
    alt: "Brooks Adrenaline GTS stabillik yugurish poyabzali",
    review: "/uz/shoe-reviews/example-shoe-review/",
    ...
    bestFor: "Yengil-o'rtacha ortiqcha pronatsiya, kundalik masofalar",
    supportType: "Yo'naltirilgan stabillik (GuideRails)",
    drop: "~12mm",
    widthOptions: "Standart, keng, juda keng",
    priceTier: 2,
  ...
  asicsGelKayano: {
    ...
    alt: "ASICS Gel-Kayano stabillik yugurish poyabzali",
    review: "/uz/shoe-reviews/asics-gel-kayano-review/",
    ...
    bestFor: "O'rtacha-og'ir ortiqcha pronatsiya, yuqori masofalar",
    supportType: "4D yo'naltirish tizimi",
    drop: "~10mm",
    widthOptions: "Standart, keng",
    priceTier: 3,
  ...
  sauconyGuide: {
    ...
    alt: "Saucony Guide yugurish poyabzali",
    review: "/uz/shoe-reviews/saucony-guide-review/",
    ...
    bestFor: "Tejamkor narxda yengil ortiqcha pronatsiya",
    supportType: "PWRRUN ko'pigi, tayanchli medial tuzilma",
    drop: "~8mm",
    widthOptions: "Standart (torroq diapazon)",
    priceTier: 1,
  ...
  newBalance928: {
    ...
    brand: "New Balance",
    category: "walking",
    categoryLabel: "Yurish",
    img: "/assets/images/products/new-balance-928.webp",
    alt: "New Balance 928 yurish poyabzali",
    review: "/uz/shoe-reviews/new-balance-928-review/",
    ...
    bestFor: "Kun bo'yi yurish, tik turish, mayda ishlar",
    supportType: "Rollbar poshna stabilizatori",
    drop: "Qattiq, past profil",
    widthOptions: "Tordan juda kenggacha",
    priceTier: 2,
  ...
  hokaBondi: {
    ...
    alt: "Hoka Bondi yurish poyabzali",
    review: "/uz/shoe-reviews/hoka-bondi-review/",
    ...
    bestFor: "Qattiq yuzada yurish, tik turib ishlash",
    supportType: "Qalin, keng asosli o'rta taglik",
    drop: "Baland stack, keng asos",
    widthOptions: "Standart, keng",
    priceTier: 2,
  ...
  skechersWork: {
    ...
    alt: "Skechers Work sirpanishga qarshi poyabzal",
    review: "/uz/shoe-reviews/skechers-work-relaxed-fit-review/",
    ...
    bestFor: "Tik turib ishlanadigan smenalar, himoya burni talab qilinmaydi",
    supportType: "Memory-foam ichki tagcha, keng asos",
    drop: "Standart",
    widthOptions: "Standart, keng",
    priceTier: 2,
  ...
  timberlandPro: {
    ...
    alt: "Timberland PRO composite burunli ish poyabzali",
    review: "/uz/shoe-reviews/timberland-pro-composite-toe-review/",
    ...
    bestFor: "Sertifikatlangan himoya burniga muhtoj ishlar",
    supportType: "Charchashga qarshi tagcha, qattiq platforma",
    drop: "Standart, mustahkamlangan",
    widthOptions: "Standart, keng",
    priceTier: 3,
  ...
  nikeMetcon: {
    ...
    brand: "Nike",
    category: "gym",
    categoryLabel: "Mashqlar",
    img: "/assets/images/products/nike-metcon.webp",
    alt: "Nike Metcon mashq poyabzali",
    review: "/uz/shoe-reviews/nike-metcon-review/",
    ...
    bestFor: "Og'ir shtanga ko'tarish",
    supportType: "Qattiq, deyarli tekis poshna plitasi",
    drop: "Minimal, tekis",
    widthOptions: "Standart, keng",
    priceTier: 3,
  ...
  asicsGelQuantum: {
    ...
    alt: "ASICS Gel-Quantum aralash mashq poyabzali",
    review: "/uz/shoe-reviews/asics-gel-quantum-review/",
    ...
    bestFor: "Aralash kardio va o'rtacha og'irlik ko'tarish",
    supportType: "O'rtacha yumshoqlik, barqaror poshna",
    drop: "Standart",
    widthOptions: "Standart, keng",
    priceTier: 2,
  ...
  birkenstockArizona: {
    ...
    brand: "Birkenstock",
    category: "sandals",
    categoryLabel: "Sandallar",
    img: "/assets/images/products/birkenstock-arizona.webp",
    alt: "Birkenstock Arizona sandallari",
    review: "/uz/shoe-reviews/birkenstock-arizona-review/",
    ...
    bestFor: "Kundalik kiyish, probka moslashuviga tayyor bo'lganlar uchun",
    supportType: "Konturli probka-lateks tagcha",
    drop: "Yo'q (sandal)",
    widthOptions: "Sozlanadigan tasmalar",
    priceTier: 2,
  ...
  oofosOoahh: {
    ...
    alt: "OOFOS OOahh tiklanish sandallari",
    review: "/uz/shoe-reviews/oofos-ooahh-review/",
    ...
    bestFor: "Moslashuv talab qilmaydi, mashqdan keyingi tiklanish uchun",
    supportType: "Yumshoq mualliflik ko'pigi, shakllangan gumbaz",
    drop: "Yo'q (sandal)",
    widthOptions: "Slaydi, sozlash yo'q",
    priceTier: 2,
  ...
  superfeetGreen: {
    ...
    brand: "Superfeet",
    category: "insoles",
    categoryLabel: "Ichki tagliklar",
    img: "/assets/images/products/superfeet-green.webp",
    alt: "Superfeet GREEN ichki tagliklari",
    review: "/uz/shoe-reviews/superfeet-green-review/",
    ...
    bestFor: "Sezilarli, aniq gumbaz cho'kishi uchun",
    supportType: "Qattiq biomexanik korpus",
    drop: "Baland, qattiq",
    widthOptions: "Kesib moslash mumkin",
    priceTier: 2,
  ...
  powerstepPinnacle: {
    ...
    alt: "Powerstep Pinnacle ortopedik ichki tagliklari",
    review: "/uz/shoe-reviews/powerstep-pinnacle-review/",
    ...
    bestFor: "Yengil-o'rtacha yassi tovon, kundalik kiyish",
    supportType: "Yarim qattiq korpus, yumshoq ustki qatlam",
    drop: "O'rtacha",
    widthOptions: "Kesib moslash mumkin",
    priceTier: 2,
  ...
  sofSole: {
    ...
    alt: "Sof Sole plantar fassiit uchun ichki tagliklari",
    review: "/uz/shoe-reviews/sof-sole-plantar-fasciitis-insoles-review/",
    ...
    bestFor: "Yengil yassi tovon, tejamkor byudjet",
    supportType: "Gel poshna yostiqchasi, o'rtacha gumbaz ko'tarilishi",
    drop: "Past",
    widthOptions: "Kesib moslash mumkin",
    priceTier: 1,
  ...
  newBalance990: {
    ...
    brand: "New Balance",
    category: "casual",
    categoryLabel: "Kundalik",
    img: "/assets/images/products/new-balance-990.webp",
    alt: "New Balance 990 seriyali kundalik tayanch krossovkasi",
    review: "/uz/shoe-reviews/new-balance-990-review/",
    ...
    bestFor: "Kundalik oddiy kiyish, keng/yassi oyoqlar",
    supportType: "Qattiq ikki zichlikdagi (ENCAP) o'rta taglik",
    drop: "Standart",
    widthOptions: "Tordan juda kenggacha",
    priceTier: 3,
