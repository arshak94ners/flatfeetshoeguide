...
var FFSG_PRODUCTS = {
  brooksAdrenaline: {
    ...
    bestFor: "Mild-to-moderate overpronation, daily miles",
    supportType: "Guided stability (GuideRails)",
    drop: "~12mm",
  ...
  asicsGelKayano: {
    ...
    bestFor: "Moderate-to-severe overpronation, higher mileage",
  ...
  sauconyGuide: {
    ...
    bestFor: "Mild overpronation on a budget",
    supportType: "PWRRUN foam, supportive medial construction",
    drop: "~8mm",
    widthOptions: "Standard (narrower range)",
    priceTier: 1,
  ...
  newBalance928: {
    ...
    bestFor: "All-day walking, standing, errands",
    supportType: "Rollbar heel stabilizer",
    drop: "Firm, low-profile",
    widthOptions: "Narrow through extra-wide",
    priceTier: 2,
  ...
  hokaBondi: {
    ...
    bestFor: "Hard-surface walking, standing jobs",
    supportType: "Thick, wide-based midsole",
    drop: "Tall stack, wide base",
    widthOptions: "Standard, wide",
    priceTier: 2,
  ...
  skechersWork: {
    ...
    bestFor: "Standing shifts, no safety-toe requirement",
    supportType: "Memory-foam insole, wide base",
    drop: "Standard",
    widthOptions: "Standard, wide",
    priceTier: 2,
  ...
  timberlandPro: {
    ...
    bestFor: "Jobs requiring certified safety-toe protection",
    supportType: "Anti-fatigue footbed, firm platform",
    drop: "Standard, reinforced",
    widthOptions: "Standard, wide",
    priceTier: 3,
  ...
  nikeMetcon: {
    ...
    bestFor: "Heavy barbell lifting",
    supportType: "Firm, near-flat heel plate",
    drop: "Minimal, flat",
    widthOptions: "Standard, wide",
    priceTier: 3,
  ...
  asicsGelQuantum: {
    ...
    bestFor: "Mixed cardio and moderate lifting",
    supportType: "Moderate cushioning, stable heel",
    drop: "Standard",
    widthOptions: "Standard, wide",
    priceTier: 2,
  ...
  birkenstockArizona: {
    ...
    bestFor: "Everyday wear, willing to break in cork",
    supportType: "Contoured cork-and-latex footbed",
    drop: "N/A (sandal)",
    widthOptions: "Adjustable straps",
    priceTier: 2,
  ...
  oofosOoahh: {
    ...
    bestFor: "Zero break-in, post-workout recovery",
    supportType: "Soft proprietary foam, molded arch",
    drop: "N/A (sandal)",
    widthOptions: "Slide, no adjustment",
    priceTier: 2,
  ...
  superfeetGreen: {
    ...
    bestFor: "Significant, noticeable arch collapse",
    supportType: "Rigid biomechanical shell",
    drop: "High, firm",
    widthOptions: "Trim-to-fit",
    priceTier: 2,
  ...
  powerstepPinnacle: {
    ...
    bestFor: "Mild-to-moderate flat feet, everyday wear",
    supportType: "Semi-rigid shell, cushioned top layer",
    drop: "Moderate",
    widthOptions: "Trim-to-fit",
    priceTier: 2,
  ...
  sofSole: {
    ...
    bestFor: "Mild flat feet, tight budgets",
    supportType: "Gel heel cushion, moderate arch bump",
    drop: "Low",
    widthOptions: "Trim-to-fit",
    priceTier: 1,
  ...
  newBalance990: {
    ...
    bestFor: "Daily casual wear, wide/flat feet",
    supportType: "Firm dual-density (ENCAP) midsole",
    drop: "Standard",
    widthOptions: "Narrow through extra-wide",
    priceTier: 3,
